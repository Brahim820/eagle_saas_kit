...
SERVER_TYPE = [
    ...
    # ('same_eagle_server', "Current Eagle Server"),
    # ('different_eagle_server', "Same machine with different eagle server"),
    # ('different_eagle_server', "Different Eagle Server"),
]
DB_SCHEME = [
...
class SaasServer(models.Model):
    ...
    eagle_url = fields.Char(string="Eagle URL")
