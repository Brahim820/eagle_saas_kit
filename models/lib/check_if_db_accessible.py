...
def isdbaccessible(host_server,db_server):
    ...
    try:
        ...
        sftp.put("/opt/eagle12/webkul_addons/eagle_saas_kit/models/lib/connect_db.py",'/tmp/connect_db.py')
        sftp.close()
...
'''
isdbaccessible(host_server =  {'user': 'eagle12', 'host':
    '192.168.10.214', 'server_type': 'remote', 'password': 'eagle12', 'port':
    '22'},db_server = {'user': 'eagle', 'host':
        '192.168.1.96', 'server_type': 'remote', 'password': 'eagle',
        'port': '5432'})
'''
